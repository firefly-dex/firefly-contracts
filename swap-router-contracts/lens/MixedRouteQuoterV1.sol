...
import '@firefly-dex/v3-periphery/contracts/base/PeripheryImmutableState.sol';
import '@firefly-dex/core-v3/contracts/libraries/SafeCast.sol';
import '@firefly-dex/core-v3/contracts/libraries/TickMath.sol';
import '@firefly-dex/core-v3/contracts/libraries/TickBitmap.sol';
import '@firefly-dex/core-v3/contracts/interfaces/IFireflyV3Pool.sol';
import '@firefly-dex/core-v3/contracts/interfaces/callback/IFireflyV3SwapCallback.sol';
import '@firefly-dex/v3-periphery/contracts/libraries/Path.sol';
import '@firefly-dex/v3-periphery/contracts/libraries/PoolAddress.sol';
import '@firefly-dex/v3-periphery/contracts/libraries/CallbackValidation.sol';
import '@firefly-dex/core-v2/contracts/interfaces/IFireflyV2Pair.sol';
...
contract MixedRouteQuoterV1 is IMixedRouteQuoterV1, IFireflyV3SwapCallback, PeripheryImmutableState {
    using Path for bytes;
    using SafeCast for uint256;
    using PoolTicksCounter for IFireflyV3Pool;
    ...
    function getPool(
        ...
        address tokenB,
        uint24 fee
    ) private view returns (IFireflyV3Pool) {
        return IFireflyV3Pool(PoolAddress.computeAddress(factory, PoolAddress.getPoolKey(tokenA, tokenB, fee)));
    }
    ...
    function getPairAmountOut(
        ...
        (uint256 reserveIn, uint256 reserveOut) = FireflyV2Library.getReserves(factoryV2, tokenIn, tokenOut);
        return FireflyV2Library.getAmountOut(amountIn, reserveIn, reserveOut);
    }

    /// @inheritdoc IFireflyV3SwapCallback
    function fireflyV3SwapCallback(
        ...
        IFireflyV3Pool pool = getPool(tokenIn, tokenOut, fee);
        ...
        )
    {
        ...
        IFireflyV3Pool pool = getPool(params.tokenIn, params.tokenOut, params.fee);
